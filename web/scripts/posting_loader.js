            ...
            if( recvAdData.code == 100) {
                for (let i = row_id_indexer; i < row_id_indexer + 4; i++) {
                    ...
                    for (let j = 0; j < 3; j++) {
                        ...
                        let appendAdHtmlCode = '<div class="col-md-4"><a style="text-decoration: none; color: inherit;" href="ad.jsp?id=' + ad_id + '"><div class="card mp-mat-sha-1"><img class="card-img-top" src="assets/images/dark-card-bg-test.jpg" alt="Card image cap"><div class="card-body"><h4 class="card-title" data-content="ad_price">&#8377; '+ ad_price + '</h4><p class="card-subtitle" data-content="ad_title">' + ad_title + '</p></div><div class="card-footer text-muted"><div class="row"><p class="col-6 my-auto">15 June</p><p class="col-6 my-auto text-right">Manipal, KA</p></div></div></div></a></div>';
            ...
            if( recvAdData.code == 100) {
                for (let i = row_id_indexer; i < row_id_indexer + 4; i++) {
                    ...
                    for (let j = 0; j < 3; j++) {
                        ...
                        let ad_price = conc_obj.ad_price;
                        let ad_location = conc_obj.ad_location;
                        let appendAdHtmlCode = '<div class="col-md-4"><a style="text-decoration: none; color: inherit;" href="ad.jsp?id=' + ad_id + '"><div class="card mp-mat-sha-1"><img class="card-img-top" src="assets/images/dark-card-bg-test.jpg" alt="Card image cap"><div class="card-body"><h4 class="card-title" data-content="ad_title">&#8377; '+ ad_price + '</h4><p class="card-subtitle" data-content="ad_title">' + ad_title + '</p></div><div class="card-footer text-muted"><div class="row"><p class="col-6 my-auto">15 June</p><p class="col-6 my-auto text-right">Manipal, KA</p></div></div></a></div>';
                        $("#ad_row_" + i).append(appendAdHtmlCode);
                    }
                }
            } else {
