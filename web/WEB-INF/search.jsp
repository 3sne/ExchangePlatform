...
<body>
    ...
    <input type="hidden" id="search_query" name="search_query" value="<%=searchQuery%>" />
    <!-- BACKGROUND TILT -->
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div id="first-img" class="d-flex text-center justify-content-center align-items-center">
                <p class="display-3" style="color: white">Search Result for '<%=searchQuery%>'</p>
            </div>
        </div>
    </div>
    ...
    <script src="scripts/search_helper.js"></script>
